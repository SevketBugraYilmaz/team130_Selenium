    ...
    public static void main(String[] args) throws InterruptedException {
       ...
       // WebElement removeButonu = driver.findElement(By.className("remove-btn"));
        ...
        if (removeButonu.isDisplayed()){
            System.out.println("Remove butonu gorme testi PASSED");
        }else{
            System.out.println("Remove butonu gorme testi FAILED");
        }
        ...
        if (addRemoveYazielementi.isDisplayed()){
            System.out.println("Add/Remove gorme testi PASSED");
        }else{
            System.out.println("Add/Remove gorme testi FAILED");
        }
    }
}
